...
# In my opinion, Machine Learning is our way of solving the problems which we encountered with some of algorithms that our machine can understand.
...
# Our plot is histogram. Our variable type is continous.
